...
const messages = {
  de: {
    ...
    dashboard: {
      ...
      medicationsSnoozed: '{count} Medikamente stummgeschaltet',
      sort: {
        alphabetical: 'A-Z',
        urgency: 'Vorrat',
      },
    ...
    medication: {
      ...
      addFailed: 'Medikament konnte nicht hinzugefügt werden',
      updateFailed: 'Medikament konnte nicht aktualisiert werden',
